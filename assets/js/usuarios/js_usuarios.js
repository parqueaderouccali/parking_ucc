...
db.on('value', function (snapshot) {
    ...
    for (usuario in usuarios) {
        ...
        row += '<tr class="UID" id="' + usuario + '">' +
            ...
            '<td> <button type="button" class="btnEdit btn btn-danger" data-toggle="modal" data-target="#exampleModalCenter"><i class="fa fa-edit form-control-feedback"></i> Editar</td>' +
            '<td> <button type="button" class="btnDelete btn btn-warning" data-toggle="modal" data-target="#exampleModalCenter"><i class="fas fa-times form-control-feedback"> </i> Eliminar</td>' +
            '</tr>';
    }
